...
void FannedCardGroup::GroupPositionTo3DScreen(
  Renderer* renderer, 
  glm::vec4& src, 
  glm::vec3& dest
) const {
...
bool FannedCardGroup::GetInsideHandBoundary(
  Renderer* renderer,
  const CursorData& renderData,
...
int FannedCardGroup::GetClosestCardIndex(
  double projectedLeftBoundary,
  double margin,
  double xGap,
  double xScale,
